...
const columns = defineVaDataTableColumns([
  { label: '診間', key: 'project_name', sortable: true },
  { label: '看診進度', key: 'status', sortable: true },
  { label: '看診醫師', key: 'team', sortable: true },
])
...
<template>
  <VaCard>
    <VaCardTitle class="flex items-start justify-between">
      <h1 class="card-title text-secondary font-bold uppercase">看診進度</h1>
      <VaButton preset="primary" size="small" to="/projects">查看所有診間看診進度</VaButton>
    </VaCardTitle>
    <VaCardContent>
